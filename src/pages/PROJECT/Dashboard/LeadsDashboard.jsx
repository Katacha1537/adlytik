...
export default function LeadsDashboard({ generalMetrics, conversionMetrics, investmentMetrics, customerData }) {
    return (
        <div>
            ...
            <div className='flex flex-col gap-4 mt-4 sm:flex-row'>
                <div className="flex flex-col gap-4 w-full sm:w-1/2">
                    ...
                    <Card className="w-full p-2 items-center ">
                        <h3 className='text-xl font-bold'>Conversas X Vendas por Dia</h3>
                        <div className='w-full'>
                ...
                <Card className="w-1/2 p-4 items-center ">
                    <h3 className='text-xl font-bold mb-2'>Regiãos de mais vendas</h3>
                    <MapChart customerData={customerData} size={350} />
                </Card>
            </div>
