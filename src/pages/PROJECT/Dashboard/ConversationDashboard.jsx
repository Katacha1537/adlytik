...
export default function ConversationDashboard({ generalMetrics, conversionMetrics, investmentMetrics, customerData }) {
    ...
    return (
        <div>
            ...
            <div className="flex gap-4 w-full mt-4">
                ...
                <Card className="w-full p-2 items-center ">
                    <h3 className='text-xl font-bold'>Clique no Link X Conversa por Dia</h3>
                    <div className='w-full'>
